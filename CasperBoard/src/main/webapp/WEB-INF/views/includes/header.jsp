                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="/resources/assets/images/users/face1.jpg" alt="John Doe"/>
                        </a>
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">Casper</div>
                    ...
                    <li>
                        <a href="/board/list"><span class="fa fa-desktop"></span> <span class="xn-text">FreeBoard</span></a>
                    </li>
            ...
            <div class="page-content">
                ...
                <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
                    ...
                    <li class="xn-icon-button pull-right">
                        <a href="/casper/logout" class="mb-control" data-box="#mb-signout"><span class="fa fa-sign-out"></span></a>                        
                    </li>
